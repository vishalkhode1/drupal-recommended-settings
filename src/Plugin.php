...
//    }
    ...
    public static function getSubscribedEvents() {
        ...
        return [
            Handler::POST_DRUPAL_SCAFFOLD_CMD => "postDrupalScaffold",
...
//            PluginEvents::COMMAND => 'onCommand',
    ...
    public function postDrupalScaffold(Event $event) {
        $this->io->write("Post Drupal scaffold command invoked.");
    }
//    /**
